  ...
  return (
    ...
    >
      ...
      <List sx={{ backgroundColor: "#002147", color: "white", height: "100%" }}>
        ...
        <ListItem disablePadding sx={{ display: "block", backgroundColor: '#315278' }} onClick={() => navigate(`/student/${id}`)}>
        ...
        <ListItem disablePadding sx={{ display: "block" }} onClick={() => navigate("/student/StudyMaterial")}>
          <ListItemButton sx={{ minHeight: 48, justifyContent: open ? "initial" : "center", px: 2.5, }}>
            <ListItemIcon
              sx={{
                minWidth: 0,
        ...
        <ListItem disablePadding sx={{ display: "block" }} onClick={() => navigate(`/student/Assessment/${id}`)}>
          <ListItemButton sx={{ minHeight: 48, justifyContent: open ? "initial" : "center", px: 2.5, }}>
            <ListItemIcon
              sx={{
                minWidth: 0,
        ...
        <ListItem disablePadding sx={{ display: "block" }} onClick={() => navigate(`/student/messages`)}>
          <ListItemButton sx={{ minHeight: 48, justifyContent: open ? "initial" : "center", px: 2.5, }}>
            <ListItemIcon
              sx={{
                minWidth: 0,
