              ...
              <div class="col-md-10 ">
                <div class="row ">
                  <div class="col-xl-4 col-lg-6">
                    <div
                      class="card l-bg-blue-dark"
                      style={{ backgroundColor: "#0079ff" }}
                    >
                      <div class="card-statistic-3 p-4">
                        <div
                          class="card-icon card-icon-large me-5"
                          style={{ color: "black" }}
                        >
                          <FaUsers size={100} />
                        </div>
                  ...
                  <div class="col-xl-4 col-lg-6">
                    <div
                      class="card l-bg-green-dark"
                      style={{ backgroundColor: "#FF0060" }}
                    >
                      <div class="card-statistic-3 p-4">
                        <div class="card-icon card-icon-large me-5">
                      ...
                      .map((item) => (
                        <>
                          <button
                            ...
                            class="  list-group-item list-group-item-action w-50 p-3 "
                          >
                            <b>Name: </b>
