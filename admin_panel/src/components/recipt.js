          ...
          >
            <header className="mt-3">
              <div className="d-flex justify-content-center">
                <p className="h3">Adhyayan Coaching Classes</p>
              </div>
              <div className="d-flex justify-content-center">
                <p>
                  <strong>Address: </strong>Harsul-Pisadevi Road
                </p>
              </div>
            </header>
            ...
            <div className="row py-2" style={{ background: "#eee" }}>
              <div className="col">
                <div className="flex-column">
                  <p className="h5">
                    <strong>{feesrecipt.name}</strong>
                  </p>
                  <p>
                    <strong>Contact No: </strong>+91 {feesrecipt.contact}
                  </p>
                  <p>
